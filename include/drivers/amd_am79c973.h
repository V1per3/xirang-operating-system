...
#ifndef __XIRANGOS__DRIVERS__AMD_AM79C973_H
#define __XIRANGOS__DRIVERS__AMD_AM79C973_H
...
namespace xirangos
{
    namespace drivers
    {
        ...
        public:
            amd_am79c973(xirangos::hardwarecommunication::PeripheralComponentInterconnectDeviceDescriptor *dev,
                         xirangos::hardwarecommunication::InterruptManager* interrupts);
            ~amd_am79c973();
